...
<div class="login-container">
    ...
    <div class="login-header">
        ...
        <div class="login-content">
            ...
            <a href="#" class="logo">
                <img src="assets/images/logo@2x.png" alt="" width="100" />
            </a>

            <p class="description">Dear {{ session('user.disp_name') }}, enter your password to unlock the screen!</p>
    ...
    <div class="login-form">
        ...
        <div class="login-content">
            ...
            <form method="post" role="form" id="form_lockscreen">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="hidden" name="username" id="username" value="{{ session('user.username') }}" autocomplete="off" />
            ...
            <div class="login-bottom-links">
                ...
                <a href="{{ url('/') }}" class="link">Sign in using different account <i class="entypo-right-open"></i></a>
            </div>
